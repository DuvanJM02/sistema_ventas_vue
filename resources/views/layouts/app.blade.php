                    ...
                    <ul class="nav metismenu">
                        ...
                        <li class="nav-dropdown active">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-meter"></i><span>Dashboard</span></a>
                            <ul class="collapse in nav-sub" aria-expanded="true">
                                <li class="active"><a href="index.html"><span>Default</span></a></li>
                        ...
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-article"></i><span>Page Layouts</span></a>
                            <ul class="collapse nav-sub" aria-expanded="false">
                                ...
                                <li><a href="layout.left-right-sidebars.html"><span>Left &amp; Right Sidebars</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-browser"></i><span>Custom Pages</span></a>
                            <ul class="collapse nav-sub" aria-expanded="false">
                        ...
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-view-thumb"></i><span>Cards</span></a>
                        ...
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-jewel"></i><span>UI Kit</span></a>
                            <ul class="collapse nav-sub" aria-expanded="false">
                        ...
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-stack"></i><span>Components</span></a>
                            <ul class="collapse nav-sub" aria-expanded="false">
                                ...
                                <li><a href="components.tooltips-popovers.html"><span>Tooltips &amp; Popovers</span></a>
                                </li>
                                <li><a href="components.ui-blocking.html"><span>UI Blocking</span></a></li>
                                <li><a href="components.drag-and-drop.html"><span>Drag and Drop</span></a></li>
                            </ul>
                        </li>
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-graph-bar"></i><span>Charts</span></a>
                            <ul class="collapse nav-sub" aria-expanded="false">
                        ...
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-to-do"></i><span>Forms</span></a>
                            <ul class="collapse nav-sub">
                                <li class="nav-dropdown">
                                    <a class="has-arrow" href="#">Basic Elements</a>
                                    <ul class="collapse nav-sub">
                                        <li><a href="forms.basic-inputs.html"><span>Basic Inputs</span></a></li>
                                        <li><a href="forms.checkbox-radio.html"><span>Checkbox &amp; Radio</span></a>
                                        </li>
                                ...
                                <li class="nav-dropdown">
                                    ...
                                    <ul class="collapse nav-sub">
                                        ...
                                        <li><a href="forms.jquery-validation.html"><span>jQuery Validation</span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-dropdown">
                                    ...
                                    <ul class="collapse nav-sub">
                                        ...
                                        <li><a href="forms.horizontal-wizard.html"><span>Horizontal Wizard</span></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-blog"></i><span>Tables</span></a>
                            <ul class="collapse nav-sub" aria-expanded="false">
                        ...
                        <li><a href="apps.messages.html"><i class="icon dripicons-message"></i><span>Messages</span></a>
                        </li>
                        <li><a href="apps.contacts.html"><i class="icon dripicons-archive"></i><span>Contacts</span></a>
                        </li>
                        <li><a href="apps.calendar.html"><i
                                    class="icon dripicons-calendar"></i><span>Calendar</span></a></li>
                        <li class="sidebar-header"><span>EXTRAS</span></li>
                        <li class="nav-dropdown">
                            <a class="has-arrow" href="#" aria-expanded="false"><i
                                    class="icon dripicons-lock"></i><span>Authentication</span></a>
                            <ul class="collapse nav-sub" aria-expanded="false">
                        ...
                        <li><a href="helper-classes.html"><i class="icon dripicons-help"></i><span>Helper
                                    Classes</span></a></li>
                    </ul>
                </nav>
            </div>
                    ...
                    <li class="nav-item nav-text dropdown dropdown-menu-md">
                        ...
                        <div class="dropdown-menu menu-icons dropdown-menu-left">
                            <div class="form-group form-filter">
                                <input type="text" placeholder="Filter location..." class="form-control filter-input"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <figure class="tint">
                                        ...
                                        <img src="{{ asset('img/demos/ecom-header.jpg') }}" alt="">
                                    </figure>
                                </div>
                            </div>
                        </div>
                ...
                <ul class="navbar-nav nav-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right p-0">
                            <div class="dropdown-menu-grid">
                                <div class="menu-grid-row">
                                    <div><a class="dropdown-item  border-bottom border-right" href="apps.mail.html"><i
                                                class="icon dripicons-mail"></i><span>Mail</span></a></div>
                                    <div><a class="dropdown-item  border-bottom" href="apps.messages.html"><i
                                                class="icon dripicons-message"></i><span>Messages</span></a></div>
                                </div>
                                <div class="menu-grid-row">
                                    <div><a class="dropdown-item  border-right" href="apps.contacts.html"><i
                                                class="icon dripicons-archive"></i><span>Contacts</span></a></div>
                                    <div> <a class="dropdown-item" href="apps.calendar.html"><i
                                                class="icon dripicons-calendar"></i><span>Calendar</span></a></div>
                                </div>
                            </div>
                        </div>
                    </li>
                                    ...
                                    <div class="card-container-wrapper">
                                            ...
                                            <div class="timeline timeline-border">
                                                <div class="timeline-list">
                                                    <div class="timeline-info">
                                                        <div>Prep for bi-weekly meeting with <a
                                                                href="javascript:void(0)"><strong>Steven
                                                ...
                                                <div class="timeline-list  timeline-border timeline-accent">
                                                    <div class="timeline-info">
                                                        ...
                                                        <small class="text-muted">07/09/18, 10:00 AM - 6:00
                                                            PM</small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="timeline-list  timeline-border timeline-warning">
                                                    <div class="timeline-info">
                                                        <div><a href="#"><strong>Approve Request</strong></a> for new
                                                            training material by</div>
                                                        <small class="text-muted">07/11/18, 9:00 AM</small>
                                                    </div>
                                                </div>
                                                <div class="timeline-list  timeline-border timeline-info">
                                                    <div class="timeline-info">
                                                        <div><a href="#"><strong>RSVP</strong></a> for this year's
                                                            hackathon.</div>
                                        ...
                                        <div class="card-container">
                                            ...
                                            <div class="row m-b-20 m-t-30">
                                                <div class="col-10"><span class="title"><i
                                                            class="icon dripicons-calendar"></i>Calendar</span></div>
                                                <div class="col-2"><input type="checkbox"
                                                        class="js-switch" checked /></div>
                                            </div>
                                            <div class="row m-b-20">
                                                <div class="col-10"><span class="title"><i
                                                            class="icon dripicons-mail"></i>Email</span></div>
                                                <div class="col-2"><input type="checkbox"
                                                        class="js-switch" checked /></div>
                                            </div>
                                            <div class="row m-b-20">
                                                <div class="col-10"><span class="title"><i
                                                            class="icon dripicons-message"></i>Messages</span></div>
                                                <div class="col-2"><input type="checkbox"
                                                        class="js-switch" /></div>
                                            </div>
                                            <div class="row m-b-20">
                                                <div class="col-10"><span class="title"><i
                                                            class="icon dripicons-stack"></i>Projects</span></div>
                                                <div class="col-2"><input type="checkbox"
                                                        class="js-switch" checked /></div>
                                            </div>
                                        </div>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                            ...
                            <img src="{{ asset('img/avatars/1.jpg') }}" class="w-35 rounded-circle" alt="Albert Einstein">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                            <div class="dropdown-header pb-3">
                                <div class="media d-user">
                                    <img class="align-self-center mr-3 w-40 rounded-circle"
                                        src="{{ asset('img/avatars/1.jpg') }}" alt="Albert Einstein">
                            ...
                            <a class="dropdown-item" href="apps.messages.html"><i class="icon dripicons-mail"></i>
                                Message <span
                                    class="badge badge-accent rounded-circle w-15 h-15 p-0 font-size-10">4</span></a>
                            <a class="dropdown-item" href="pages.profile.html"><i class="icon dripicons-user"></i>
                                Profile</a>
                            <a class="dropdown-item" href="pages.my-account.html"><i class="icon dripicons-gear"></i>
                                Account Settings </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#"><i class="icon dripicons-lock"></i> Lock Account</a>
                            <a class="dropdown-item" href="auth.sign-in.html"><i
                                ...
                                <div class="row m-0 col-border-xl">
                                    <div class="col-md-12 col-lg-6 col-xl-3">
                                        <div class="card-body">
                                            ...
                                            <small class="text-muted float-right m-t-5 mb-3 counter append-percent"
                                                data-count="72">
                                                0
                                            </small>
                                        </div>
                                    ...
                                    <div class="col-md-12 col-lg-6 col-xl-3">
                                        <div class="card-body">
                                            ...
                                            <div class="progress progress-add-to-cart mt-4" style="height:7px;">
                                                <div class="progress-bar bg-accent" role="progressbar" style=""
                                    ...
                                    <div class="col-md-12 col-lg-6 col-xl-3">
                                        <div class="card-body">
                                            ...
                                            <h5 class="card-title m-b-5 prepend-currency counter" data-count="37873">0
                                            </h5>
                                            <h6 class="text-muted m-t-10">
                                                Total Revenue
                                            </h6>
                            ...
                            <div class="card-deck m-b-30">
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <h4 class="card-title text-info p-t-10 p-l-15">67,325 <i
                                                class="zmdi zmdi-trending-up text-info"></i></h4>
                                        <div class="h-200">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <h4 class="card-title text-warning p-t-10 p-l-15">3.69% <i
                                                class="zmdi zmdi-trending-down text-warning"></i></h4>
                                        <div class="h-200">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <h4 class="card-title text-primary p-t-10 p-l-15">13m 36s <i
                                                class="zmdi zmdi-trending-up text-primary"></i></h4>
                                        <div class="h-200">
                        ...
                        <div class="col-lg-12 col-xl-7">
                            <div class="card">
                                <div class="card-header">Recent Transactions
                                    <ul class="actions top-right">
                                        <li><a href="javascript:void(0)" data-q-action="card-expand"><i
                                                    class="icon dripicons-expand-2"></i></a></li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="recent-transaction-table" class="table table-striped table-bordered"
                                            style="width:100%">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>06/19/18</td>
                                                    <td>$600</td>
                                                    <td><span class="badge badge-pill badge-danger">Reversed</span>
                                                    </td>
                                                    <td>
                                                        <a href="javascript:void(0)"><i
                                                                class="icon dripicons-download"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>06/15/18</td>
                                                    <td>$650</td>
                                                    <td><span class="badge badge-pill badge-danger">Canceled</span>
                                                    </td>
                                                    <td>
                                                        <a href="javascript:void(0)"><i
                                                                class="icon dripicons-download"></i></a>
                        ...
                        <div class="col-lg-12 col-xl-5">
                            <div class="card">
                                <div class="card-header"><span class="m-t-10 d-inline-block">Employee Report</span>
                                    <ul class="nav nav-pills nav-pills-primary float-right" id="pills-demo-sales"
                                        role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="pills-month-tab" data-toggle="tab"
                                                href="#sales-month-tab" role="tab">Month</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-year-tab" data-toggle="tab"
                                                href="#sales-year-tab" role="tab">Year</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body p-0">
                                    <div class="tab-content" id="pills-tabContent-sales">
                                        <div class="tab-pane fade show active" id="sales-month-tab" role="tabpanel"
                                            ...
                                            <table class="table v-align-middle">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/27.jpg') }}" alt="">
                                                            <strong class="nowrap">Robert Norris</strong>
                                                        </td>
                                                        <td>$37,000</td>
                                                        <td><span class="badge badge-pill badge-success">Above</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/47.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/24.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/01.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/09.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/26.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/11.jpg') }}" alt="">
                                                            <strong class="nowrap">Aaron Elliott</strong>
                                                        </td>
                                                        <td>$8,300</td>
                                                        <td><span class="badge badge-pill badge-danger">Danger</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border-none"><img
                                                                class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/21.jpg') }}" alt="">
                                                            <strong class="nowrap">Rebecca Harris</strong>
                                                        </td>
                                                        <td class="border-none">$4,000</td>
                                                        <td class="border-none"><span
                                                                class="badge badge-pill badge-danger">Danger</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="tab-pane fade" id="sales-year-tab" role="tabpanel"
                                            ...
                                            <table class="table v-align-middle">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/02.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/6.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/7.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/35.jpg') }}" alt="">
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/38.jpg') }}" alt="">
                                                            <strong class="nowrap">Josh Lynch</strong>
                                                        </td>
                                                        <td>$293,500</td>
                                                        <td><span class="badge badge-pill badge-warning">Pending</span>
                                                    ...
                                                    <tr>
                                                        <td><img class="align-self-center mr-3 ml-2 w-50 rounded-circle"
                                                                src="{{ asset('img/avatars/30.jpg') }}" alt="">
                ...
                <div class="sidebar-content">
                    <div class="tab-panel m-b-30" id="sidebar-tabs">
                        <ul class="nav nav-tabs primary-tabs">
                            ...
                            <li class="nav-item" role="presentation"><a href="#sidebar-contact"
                                    class="nav-link" data-toggle="tab" aria-expanded="true">Contacts</a></li>
                        </ul>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-a.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-a.css') }}">
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-b.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-b.css') }}">
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-c.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-c.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-dark"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-d.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-d.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-dark"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-e.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-e.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-dark"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-f.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-f.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-dark"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-g.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-g.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-dark"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-h.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-h.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-dark"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-i.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-i.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-j.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-j.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-light"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-k.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-k.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-light"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-l.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-l.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-light"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-m.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-m.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-light"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-n.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-n.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-light"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-o.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-o.css') }}">
                                                    <input type="radio" name="setting-theme">
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-light"></span>
                                        ...
                                        <div class="col-6 col-md-3 p-5 m-b-10">
                                            <div class="color-option-check">
                                                <h6 class="title text-center">theme-p.css</h6><label
                                                    data-load-css="{{ asset('css/layouts/vertical/themes/theme-p.css') }}">
                                                    <input type="radio" name="setting-theme" />
                                                    <span class="icon-check"></span>
                                                    <span class="split">
                                                        <span class="color bg-menu-light"></span>
                                ...
                                <div class="qt-scroll" data-scroll="minimal-dark">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="John Smith">
                                            <span class="float-left"><img src="{{ asset('img/avatars/01.jpg') }}" alt=""
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Allison Grayce">
                                            <span class="float-left"><img src="{{ asset('img/avatars/06.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/07.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                                            <span class="float-left"><img src="{{ asset('img/avatars/11.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="John Smith">
                                            <span class="float-left"><img src="{{ asset('img/avatars/02.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Allison Grayce">
                                            <span class="float-left"><img src="{{ asset('img/avatars/16.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/08.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                                            <span class="float-left"><img src="{{ asset('img/avatars/13.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="John Smith">
                                            <span class="float-left"><img src="{{ asset('img/avatars/03.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Allison Grayce">
                                            <span class="float-left"><img src="{{ asset('img/avatars/12.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/09.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="John Smith">
                                            <span class="float-left"><img src="{{ asset('img/avatars/04.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Allison Grayce">
                                            <span class="float-left"><img src="{{ asset('img/avatars/05.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                                            <span class="float-left"><img src="{{ asset('img/avatars/14.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/10.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/18.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                                            <span class="float-left"><img src="{{ asset('img/avatars/17.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/20.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                                            <span class="float-left"><img src="{{ asset('img/avatars/21.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/22.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                                            <span class="float-left"><img src="{{ asset('img/avatars/23.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/25.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                        ...
                                        <li class="list-group-item" data-chat="open" data-chat-name="Johanna Kollmann">
                                            <span class="float-left"><img src="{{ asset('img/avatars/26.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
                                    ...
                                    <ul class="list-group p-0">
                                        <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                            <span class="float-left"><img src="{{ asset('img/avatars/27.jpg') }}" alt=""
                                                    class="rounded-circle max-w-50 m-r-10"></span>
                                            <i class="badge mini success status"></i>
                                            <div class="list-group-item-body">
