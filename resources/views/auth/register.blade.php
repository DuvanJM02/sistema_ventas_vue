            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="document" class="col-md-4 col-form-label text-md-end">{{ __('Tipo de Identificación') }}</label>

                            <div class="col-md-6">
                                <select id="document" type="text" class="form-control @error('document') is-invalid @enderror" name="document" value="{{ old('document') }}" required>
                        ...
                        <div class="row mb-3">
                            <label for="n-doc" class="col-md-4 col-form-label text-md-end">{{ __('Número Identificación') }}</label>

                            <div class="col-md-6">
                                <input id="n-doc" type="text" class="form-control @error('n-doc') is-invalid @enderror" name="n-doc" value="{{ old('n-doc') }}" required autocomplete="n-doc" autofocus>
